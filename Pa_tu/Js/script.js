...
let caritaEnamorada = '😍';
console.log(caritaEnamorada);
// o
let caritaEnamoradaHTML = "&#128521;";
console.log(caritaEnamoradaHTML);
...
function showSignature() {
  ...
  signature.textContent = firma ? decodeURIComponent(firma) : "Siempre serás mi enojona favorita"+ caritaEnamorada;
